...
export const MEAL_PLAN_TEMPLATES: MealPlanTemplate[] = [
  ...
  {
    key: 'comeback-phase1',
    name: 'The Comeback — Phase 1',
    tagline:
      'Companion to The Comeback 5-Day: ~2,700 kcal lifting days, 2,400–2,500 fast days, ~190–200 g protein. No corn, no seeds, no popcorn — by construction.',
    goal: 'lose',
    style: ['High protein', 'Low carb', 'High fiber', 'No corn or seeds'],
    kcalPerDay: 2650,
    proteinPerDay: 195,
    note:
      'Run this week on repeat for months 1–6 (330 → ~290 lb). Tue/Thu are fast days: breakfast at 9:00, lunch 12:30, the DINNER slot is the 3:15 pm final meal — nothing after 4 pm, 5-mile elliptical at 6:30. Lifting days: train 5:30–7, the snack slot includes the post-lift shake. Last food ≥3 h before bed, every night.',
    pools: {
      breakfast: [],
      lunch: [],
      dinner: [],
    ...
    days: [
      {
        breakfast: [s('The Comeback Omelet')],
        lunch: [s('Comeback Chicken Salad Bowl')],
        dinner: [s('Comeback Salmon Plate')],
        snack: [s('Greek Yogurt Berry Bowl'), s('Comeback Post-Lift Shake'), s('Apple with Peanut Butter')],
      },
      {
        breakfast: [s('Break-Fast Eggs and Salmon')],
        lunch: [s('Fast-Window Beef Bowl')],
        dinner: [s('Final-Meal Chicken Thighs')],
        snack: [s('Protein Yogurt Cup')],
      },
      {
        breakfast: [s('Smoked Salmon Breakfast Plate')],
        lunch: [s('Grilled Chicken Power Salad')],
        dinner: [s('Sirloin with Roasted Brussels'), s('Roasted Sweet Potato Cubes')],
        snack: [s('Cottage Cheese Power Bowl'), s('Comeback Post-Lift Shake'), s('Apple with Peanut Butter')],
      },
      {
        breakfast: [s('Break-Fast Eggs and Salmon')],
        lunch: [s('Fast-Window Beef Bowl')],
      ...
      },
      {
        ...
        lunch: [s('Comeback Chicken Salad Bowl')],
        dinner: [s('Beef and Broccoli'), s('Herbed Cauliflower Mash')],
        snack: [s('Cottage Cheese Power Bowl'), s('Trail Fuel Mix')],
      },
      {
        breakfast: [s('Smoked Salmon Breakfast Plate')],
        lunch: [s('Chicken Caesar-ish Salad')],
        dinner: [s('Sunday Steak and Roast Veg')],
        snack: [s('Cottage Cheese with Berries'), s('Hard-Boiled Egg Pack')],
      },
    ],
  },
];
